...
public class BoundryDriver {
	...
	public void signup() {
		...
		System.out.println("Successfully signentitydriver in.");
		System.out.println("Waiting for admin to varify request.");
		modeldriver.addDriver(this.entitydriver);
		System.out.print(modeldriver.getDrivers());
	}
	...
	public void setFavArea() {
		...
		modeldriver.FavoriteAreas.add(input);
	}
	...
	public void mainDriver() {
		...
		if (driverChoice.equals("1")) {
			...
			System.out.println(modeldriver.getFavArea());
			System.out.println("");
		}
			...
			entitydriver.n.setUser(entityuser);
			entitydriver.setNotifier(n);
